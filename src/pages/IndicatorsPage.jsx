...
function IndicatorsPage() {
    ...
    const tableValues = [
        ...
        {num: '6', name: 'Centro comercial Moctezuma', ismerenie: 'sm', etap: '3 этап'},
        {num: '7', name: 'Centro comercial Moctezuma', ismerenie: 'sm', etap: '3 этап'},
        {num: '8', name: 'Centro comercial Moctezuma', ismerenie: 'sm', etap: '3 этап'},
    ];
