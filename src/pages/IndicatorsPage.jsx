...
function IndicatorsPage() {
    ...
    const setTables = async (memberName) => {
        let tableReport = await apiService.getIndicators(memberName);
    ...
    const tableValues = [
        ...
        {num: '6', name: 'Centro comercial Moctezuma', ismerenie: 'sm'},
        {num: '7', name: 'Centro comercial Moctezuma', ismerenie: 'sm'},
        {num: '8', name: 'Centro comercial Moctezuma', ismerenie: 'sm'},
    ];
                ...
                <div className='row justify-content-center' style={rowFix}>
                    <div className='col col-sm-12 col-lg-8'>
                        ...
                        <div className='sectionBox marginBoxBottom'>
                            <h4 style={{marginBottom: '20px'}}>Показатели выполненных норм</h4>
