...
import {apiService} from "../TimerPage.jsx";

const TestCircularTimer = () => {
...
/*            const response = await fetch(apiUrl);
    ...
    const initialSeconds = timeToSeconds(gameState.duration);
    const leftSeconds = timeToSeconds(gameState.countdown);
    const [timeLeft, setTimeLeft] = useState(timeToSeconds(gameState.countdown));
    ...
    const toggleTimer = async () => {
        ...
        if(gameState.countdown == gameState.duration){
...
/*        else{
    ...
    const resetTimer = () => {
        setIsRunning(false);
        setTimeLeft(timeToSeconds(gameState.countdown));
        clearInterval(intervalRef.current);
    };
    ...
    return (
        <div className="timer-container">
            ...
            <div className="timer-controls">
                ...
                <h2>{strokeDashoffset}</h2>
            </div>
        </div>
    );
};

export default TestCircularTimer;
